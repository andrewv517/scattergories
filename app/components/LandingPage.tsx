                    ...
                    games.length > 0 ?
                                        ...
                                        <div>
                                            {
                                                game.joinable ? (
                                                    <button
                                                        className="flex flex-row items-center space-x-4 w-fit m-auto px-4 py-1 rounded-xl text-white drop-shadow-xl bg-green-600"
                                                        onClick={() => handleModal('join', game.id)}>
                                                        <span>Join</span>
                                                        ...
                                                        <div
                                                            className="flex-1 flex justify-start">Wait for round to end...</div>
                                                )
                                            }
                        ...
                        <div className="flex justify-center items-center space-x-2">
                            ...
                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white"
                                ...
                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="white"
